...
# Kernel base version
KERNEL_BASE_VERSION = 5.15-167

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = video=vfb:640x400,bpp=32,memsize=3072000 pstore.compress=none printk.devkmsg=on mem.enable_mglru=1 bootconfig console=tty0 droidian.lvm.prefer
...
# Defconfig to use
# Copied from https://github.com/LineageOS/android_device_motorola_rtwo/blob/843ef872f0e9f0025a672cf06b86d98f7ba8249b/BoardConfig.mk#L26
# Copied from https://github.com/LineageOS/android_device_motorola_sm8550-common/blob/lineage-21/BoardConfigCommon.mk
...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/vendor/qcom/kalama-v2-rtwo-base.dtb
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/vendor/*/*.dtbo
...
KERNEL_BOOTIMAGE_PAGE_SIZE = 0x00001000
...
FLASH_INFO_MANUFACTURER = Motorola

# Device model. This must match the `ro.product.vendor.model`
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Moto X40
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc SM8550

# Space-separated list of supported device ids as reported by fastboot
# Todo:
FLASH_INFO_DEVICE_IDS = rtwo
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, clang-android-12.0-r416183b, libelf-dev, dwarves
